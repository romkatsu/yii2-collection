...
use Yiisoft\Yii\Collection\Collection;
...
class CollectionTest extends TestCase
{
    ...
    public function testIteratorCurrent(): void
    {
        ...
        $this->assertSame($models[0], $collection->getIterator()->current());
    }
    ...
    public function testIteratorKey(): void
    {
        $models = $this->getIteratorModels();
        $collection = new Collection($models);
        $this->assertSame(0, $collection->getIterator()->key());
    }

    public function testIteratorNext(): void
    {
        $models = $this->getIteratorModels();
        $iterator = (new Collection($models))->getIterator();

        $iterator->next();
        $this->assertSame($models[1], $iterator->current());
        $iterator->next();
        $this->assertSame($models[2], $iterator->current());
        $iterator->next();
    ...
    public function testIteratorValid(): void
    {
        ...
        $this->assertFalse($collection->getIterator()->valid());

        $models = $this->getIteratorModels();
        $collection = new Collection($models);
        $this->assertTrue($collection->getIterator()->valid());
    }
    ...
    public function testSortByKey(): void
    {
        ...
        $this->assertEquals(
            [4 => 5, 5 => 4, 44 => 55, 55 => 44],
            $collection->sortByKey(SORT_ASC, SORT_REGULAR)->getData()
        );
        $this->assertEquals(
            [4 => 5, 44 => 55, 5 => 4, 55 => 44],
            $collection->sortByKey(SORT_ASC, SORT_STRING)->getData()
        );
        $this->assertEquals(
            [55 => 44, 44 => 55, 5 => 4, 4 => 5],
            $collection->sortByKey(SORT_DESC, SORT_REGULAR)->getData()
        );
        $this->assertEquals(
            [55 => 44, 5 => 4, 44 => 55, 4 => 5],
            $collection->sortByKey(SORT_DESC, SORT_STRING)->getData()
        );
    }
